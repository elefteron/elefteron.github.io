...
/**/ 
  ...
  acvCap=['À','Å','È','Î','Ó','Ú','Þ','ß'] // cyr vowels to be accented
  acvSma=['à','å','è','î','ó','ú','þ','ÿ']
  var sl=sr='';
...
// --- 
  cyrWinCap='ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞß '// also sort order
  cyrWinSma='àáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ '
